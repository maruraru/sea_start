        ...
        <div class='row'>
          <div class='ligth-backgroud of-x-hidden b-shadow-03 h-50 col-4 py-2 rounded'>
            <div class ='row d-flex justify-content-end align-items-end mx-0 mb-3 px-0 py-1'>
              ...
              <h5 class='uppercase font-14px weight-600 m-0'>Фамилия Имя Отчество</h5>
            </div>
            <div class ='row d-flex justify-content-end align-items-end mx-0 mb-3 p-0'>
              <h5 class='uppercase font-14px weight-600 m-0'>Номер телефона</h5>
            </div>
            <div class ='row d-block text-right mx-0 mb-2 p-0'>
              <p class='font-14px weight-400 m-0'>Город</p>
              <p class='font-14px weight-400 m-0'>Школа</p>
              <p class='font-14px weight-400'>Класс</p>
            </div>
