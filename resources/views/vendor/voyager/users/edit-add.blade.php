                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="second_name" name="second_name" placeholder="Фамилия"
                                       value="@if(isset($dataTypeContent->second_name)){{ $dataTypeContent->second_name }}@endif">
                            </div>

                            <div class="form-group">
                                <label for="last_name"> Отчество </label>
                                <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Отчество"
